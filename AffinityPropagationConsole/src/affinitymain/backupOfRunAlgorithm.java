 ...
 */
public class backupOfRunAlgorithm {
    ...
    public backupOfRunAlgorithm(String inputpath, String outpath, double lambda, int iterations, Integer convits, double preferences, String kind) {
    ...
    public void setParemeters() {
        ...
        try {
            ...
            Logger.getLogger(backupOfRunAlgorithm.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            if (scanner != null) {
                scanner.close();
            }
