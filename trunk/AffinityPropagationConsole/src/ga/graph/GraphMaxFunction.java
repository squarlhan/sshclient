 ...
 * @since 2.0
 */
public class GraphMaxFunction extends FitnessFunction {
	 ...
	 * value of the Chromosome's genes interpreted as bits. However, it would be
	 * better to return the value raised to a fixed power to exaggerate the
	 * difference between the higher values. For example, the difference between
	 * 254 and 255 is only about .04%, which isn't much incentive for the
	 * selector to choose 255 over 254. However, if you square the values, you
	 * then get 64516 and 65025, which is a difference of 0.8% -- twice as much
