...
public class SearchAction extends ActionSupport{
	...
	public String Search_Gene() throws ClassNotFoundException {
		
		//得到Gene查询结果
		List<String> Gene=se.Query_Gene(Gene_name);
		if(Gene==null)
		{
			tip = "wrong gene name!";
			return ERROR;
		...
		//List<String> Taxonomy=se.Query_Taxonomy(Gene);
		...
		//得到Reference_location列表resultlist_Reference_location
			setResultlist_Reference_location(se.Query_Reference_location(Reference));
		return SUCCESS;
		}
	}
...
@Resource
	...
	public void setResultlist_Promoter_name(List<String> resultlist_Promoter_name) {
	...
	public void setResultlist_Resource_name(List<String> resultlist_Resource_name) {
	...
	public void setResultlist_Resource_link(List<String> resultlist_Resource_link) {
	...
	public void setResultlist_Homology_name(List<String> resultlist_Homology_name) {
